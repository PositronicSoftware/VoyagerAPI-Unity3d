...
namespace VRStandardAssets.Flyer
{
    ...
    public class FlyerMovementController : MonoBehaviour
    {
        ...
        [SerializeField] private bool m_IsGameRunning;                               // Whether the game is running.
        ...
        private IEnumerator MoveFlyer ()
        {
            while (m_IsGameRunning)
            {
                ...
                m_TargetMarker.position = m_CameraContainer.position + (m_CameraContainer.forward * m_DistanceFromCamera);
                ...
                m_Flyer.rotation = m_TargetMarker.rotation;
