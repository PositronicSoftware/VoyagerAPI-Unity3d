...
[CustomPropertyDrawer(typeof(TransformCurveBehaviour))]
public class TransformCurveDrawer : PropertyDrawer
{
    ...
    {
        int fieldCount = property.FindPropertyRelative ("tweenType").enumValueIndex == (int)TransformCurveBehaviour.TweenType.Custom ? 5 : 3;
		fieldCount += 1;
    ...
    public override void OnGUI (Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (tweenTypeProp.enumValueIndex == (int)TransformCurveBehaviour.TweenType.Custom)
        {
		...
		singleFieldRect.y += EditorGUIUtility.singleLineHeight;
        EditorGUI.PropertyField(singleFieldRect, modeProp);
    }
}
